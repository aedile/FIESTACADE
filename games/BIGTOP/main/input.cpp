/*
 * input.cpp - medal controls for Mr. Do! (held upright, like Pac-Man)
 *
 ...
 *
 * Mr. Do! is a four-way game: he digs in one direction at a time.
 *
 *   twist left / right  -> left and right
 *   tip away / toward   -> up and down
 *   BOOT button         -> throw the power ball; hold 3 s for sound off and on
...
void input_update(md_input_t *in)
{
