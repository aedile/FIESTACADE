/*
 * input.cpp - medal controls for Burger Time (held upright, like Pac-Man)
 *
 ...
 *
 * Burger Time is a four-way game: Peter Pepper walks one way at a time.
 *
 *   twist left / right  -> left and right
 *   tip away / toward   -> up and down
 *   BOOT button         -> pepper; hold 3 s for sound off and on
...
void input_update(bt_input_t *in)
{
