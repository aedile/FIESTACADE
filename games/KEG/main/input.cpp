/*
 * input.cpp - medal controls for Tapper (held upright, like Pac-Man)
 *
 ...
 *
 * Tapper is a four-way game: along the bar, or up and down between bars.
 *
...
void input_init(void)
{
    ...
    cfg.imu_period_us = 33000;   /* a four-way stick does not need the IMU every frame, and a read costs 2 ms */
...
void input_update(tap_input_t *in)
{
