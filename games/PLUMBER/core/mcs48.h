 ...
 *   MCS48_P1_IN()         read port 1 (optional; defaults to the last value written)
 */
#ifndef MCS48_H
#define MCS48_H
#include <stdint.h>
...
typedef struct {
    ...
    uint8_t ram[128];            /* 64 on an 8035/8039, 128 on the 8049 class (Mario's M58715) */
    uint8_t p1, p2;
...
static int mcs48_step(mcs48_t *c)
{
    ...
    case 0x09: c->a = MCS48_P1_IN(); cyc = 2; break;               /* IN A,P1 */
    case 0x0a: c->a = MCS48_P2_IN(); cyc = 2; break;              /* IN A,P2 */
    case 0x10: case 0x11: c->ram[R(op & 1) & 0x7f]++; break;      /* INC @Rr: the byte pointed at */
    ...
    case 0x20: case 0x21: { uint8_t addr = (uint8_t)(R(op & 1) & 0x7f); uint8_t t = c->ram[addr];
    ...
    case 0x30: case 0x31: { uint8_t addr = (uint8_t)(R(op & 1) & 0x7f);
    ...
    case 0x40: case 0x41: c->a |= c->ram[R(op & 1) & 0x7f]; break;
    ...
    case 0x50: case 0x51: c->a &= c->ram[R(op & 1) & 0x7f]; break;
    ...
    case 0x60: case 0x61: mcs48_add(c, c->ram[R(op & 1) & 0x7f], 0); break;
    ...
    case 0x70: case 0x71: mcs48_add(c, c->ram[R(op & 1) & 0x7f], (uint8_t)((c->psw & PSW_CY) ? 1 : 0)); break;
    ...
    case 0xa0: case 0xa1: c->ram[R(op & 1) & 0x7f] = c->a; break; /* MOV @Rr,A */
    ...
    case 0xb0: case 0xb1: c->ram[R(op & 1) & 0x7f] = IMM(); cyc = 2; break;
    ...
    case 0xd0: case 0xd1: c->a ^= c->ram[R(op & 1) & 0x7f]; break;
    ...
    case 0xf0: case 0xf1: c->a = c->ram[R(op & 1) & 0x7f]; break; /* MOV A,@Rr */
